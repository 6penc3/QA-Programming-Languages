...
public class Conversion : MonoBehaviour
{
    ...
    public TMP_InputField performanceTask1Input;
    public TMP_InputField performanceTask2Input;
    public TMP_InputField writtenWorks1Input; 
    public TMP_InputField writtenWorks2Input; 
    public TMP_InputField writtenWorks3Input; 
